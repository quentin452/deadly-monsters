...
public class ModEntities
{
    public static void init()
    {
        ...
        //Mutant Steve
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":mutant_steve");
        ...
        //Freezer
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":freezer");
        ...
        //Climber
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":climber");
        ...
        //Zombie Chicken
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":zombie_chicken");
        ...
        //Baby
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":unborn_baby");
        ...
        //Wideman
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":fallen_leader");
        ...
        //Woman
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":bloody_maiden");
        ...
        //Entrail
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":entrail");
        ...
        //Present
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":present");
        ...
        //Stranger
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":stranger");
        ...
        //Haunted Cow
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":haunted_cow");
        ...
        //Topielec
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":topielec");
        ...
        //Lucky Egg
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":lucky_egg");
        EntityRegistry.registerModEntity(resLocation, EntityLuckyEgg.class, "lucky_egg", id++, MainMod.instance, 64, 3, true);

        //Dagon
        resLocation = new ResourceLocation(MainMod.MOD_ID + ":dagon");
